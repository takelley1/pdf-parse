...
#parse here
$text = Get-Content -Path $workingdir\2875-output.txt #import text created from pdftotext
    $text.GetType() | Format-Table -Autosize #create array from text data
        
        $date = $text[35] #date field on 2875, always on line 35
